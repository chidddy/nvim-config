-- https://github.com/ignacio/StackTracePlus/blob/master/README.md
-- tables
local _G = _G
...
add_known_module('vim', 'vim module')
...
===============
    ...
    while info do
        ...
        elseif info.what == 'C' then
            ...
            local function_name = m_user_known_functions[info.func]
                or m_known_functions[info.func]
                or info.name
                or tostring(info.func)
