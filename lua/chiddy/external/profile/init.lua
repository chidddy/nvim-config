local autocmd = require('chiddy.external.profile.autocmd')
local clock = require('chiddy.external.profile.clock')
local instrument = require('chiddy.external.profile.instrument')
local util = require('chiddy.external.profile.util')
local M = {}
